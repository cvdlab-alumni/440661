...
/*      floorTex.repeat.x = 400 / 16;
      ...
      var kitchenFloor = createMesh(new THREE.PlaneGeometry( 5.1, 5, 20, 20 ), "marble.jpg", "marble-normal.jpg");
      ...
      var rightRoomFloor = createMesh(new THREE.PlaneGeometry( 5.1, 5.1, 20, 20 ), "marble.jpg", "marble-normal.jpg");
      ...
      //Hall south wall
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("hall"), options), "stucco.jpg", "stucco-normal.jpg");
      var shapeLength = 8.3;
      ...
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("hallSx"), options), "stucco.jpg", "stucco-normal.jpg");
      shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      ...
      //Hall East wall
      var hallY = 10.2; //hall Y length 
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("hallDx"), options), "stucco.jpg", "stucco-normal.jpg");
      shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = 1.5*Math.PI;
      ...
      //Kitchen west wall 
      var hallY = 10.2; //hall Y length 
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("kitchenSx"), options), "stucco.jpg", "stucco-normal.jpg");
      shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = 1.5*Math.PI;
      ...
      //Kitchen North wall
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("rRoomSx"), options), "stucco.jpg", "stucco-normal.jpg");
      shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      ...
      //Right room east
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("rRoomDx"), options), "stucco.jpg", "stucco-normal.jpg");
      shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = 1.5*Math.PI;
      shape.position.x = 8.3+2.61+0.1+5.089;
      ...
      //Right room north
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("rRoomNth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      ...
      //Left room south
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("lRoomSth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Left room east
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("lRoomDx"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = 1.5*Math.PI;
      ...
      //Left room west
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("lRoomSx"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = -1.5*Math.PI;
      shape.position.x = 2.6+0.01;
      ...
      //Bathroom west
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("bath"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Bathroom south
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("bathSth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Upper room south
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("uppRoomSth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Upper room south2
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("uppRoomSth2"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Upper room west 2
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("uppRoomSx"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = -1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Corridor north
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("corridorNth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Corridor south
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("corridorSth"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      //shape.rotation.y = 1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
      ...
      //Corridor west
      var shape = createMesh(new THREE.ExtrudeGeometry(drawShapeHall("corridorSx"), options), "stucco.jpg", "stucco-normal.jpg");
      //shapeLength = 8.3;
      shape.rotation.x = 0.5 * Math.PI;
      shape.rotation.y = -1.5*Math.PI;
      //shape.rotation.y = 2*Math.PI;
...
function addGarden(apartment) {
      loadFurniture('blackTupelo', apartment, 13, -3.5, 0, 0.5 * Math.PI, 0, 0, 1/3, 1/3, 1/3);
      ...
      loadFurniture('child_swing', apartment, 5, -2, 1.1, 0.5 * Math.PI, 0.5 * Math.PI, 0, 1/80, 1/80, 1/80);
      loadFurniture('table_tennis', apartment, 1.2, 6, 1.4, 0.5 * Math.PI, 0.5 * Math.PI, 0, 1/120, 1/60, 1/120);
