...
Examples =
{
	...
	smoke :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/images/smokeparticle.png'),
		...
		particlesPerSecond : 200,
		particleDeathAge   : 2.0,
		emitterDeathAge    : 1000
	},

	clouds1 :
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( -60, 350,  -10),
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/images/cloud.png'),
	...
	clouds2 :
		{
				positionStyle  : Type.CUBE,
				positionBase   : new THREE.Vector3( 200, 250,  -300),
				positionSpread : new THREE.Vector3(    0,  50, 60 ),
	...
	snow :
	{
		...
		particleTexture : THREE.ImageUtils.loadTexture( 'assets/images/snowflake.png' ),
